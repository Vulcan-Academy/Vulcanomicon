...
* __Observable__: A unit of information that an __Agent__ has access to. This can be information acquired through any __Agent__ faculty. For example, human __Agents__ can __Observe__ sight, sound, thoughts, and many others. 
