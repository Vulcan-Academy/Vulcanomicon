...
* __Observation Space__: The set of all __Observations__ that a particular __Agent__ may observe. All __Observations__ percieved by an __Agent__ are sampled from its __Observation Space__.
...
* __Action Space__: The set of all __Actions__ that a particular __Agent__ may perform. All __Actions__ percieved by an __Agent__ are sampled from its __Action Space__.
